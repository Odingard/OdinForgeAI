...
const FINDING_NODE_MAP: Record<string, NodeMapping> = {
  ...
  "subdomain:takeover-candidate":       { tactic: "resource-development",  nodeType: "entry", compromiseLevel: "limited" },
  "subdomain:environment-leak":         { tactic: "initial-access",        nodeType: "entry", compromiseLevel: "user" },
  "subdomain:admin-panel-exposed":      { tactic: "initial-access",        nodeType: "entry", compromiseLevel: "admin" },
  "subdomain:sensitive-service-exposed": { tactic: "initial-access",       nodeType: "entry", compromiseLevel: "user" },
  "subdomain:data-service-exposed":     { tactic: "initial-access",        nodeType: "entry", compromiseLevel: "admin" },
  "subdomain:shadow-it-risk":           { tactic: "reconnaissance",        nodeType: "pivot", compromiseLevel: "none" },

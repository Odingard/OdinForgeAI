...
func Detect() DetectionResult {
	...
	case "windows":
		...
		result.CanAutoInstall = isWindowsAdmin()
...
func isWindowsAdmin() bool {
	...
	// On Windows, try to open a protected registry key
	// For simplicity, we'll check if we can create a file in system32
	// This is a heuristic - proper check would use Windows API
	return os.Geteuid() == 0 // This works differently on Windows
}
